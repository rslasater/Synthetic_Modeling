...
def generate_post_date(transaction_dt: datetime) -> datetime:
    """Generate a posting datetime within banking hours on a business day."""
    post_dt = transaction_dt + timedelta(days=random.randint(0, 2))
    post_dt = post_dt.replace(hour=random.randint(8, 16),
